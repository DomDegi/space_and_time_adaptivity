...
public:
   ...
   */
  RightHandSide(const unsigned int N_in, const double sigma_in,
                const double a_in, const Point<dim> &x0_in, const double Q_in)
    : Function<dim>(), N(N_in), sigma(sigma_in), a(a_in), x0(x0_in), Q(Q_in)
  {}
