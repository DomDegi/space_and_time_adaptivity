...
bool
ask_bool(const std::string &question)
{
  while(true)
    {
...
double
ask_double_default(const std::string &question, const double default_value)
{
  while(true)
    {
...
unsigned int
ask_uint_default(const std::string &question, const unsigned int default_value)
{
  while(true)
    {
      std::cout << question << " [default=" << default_value << "]: ";
